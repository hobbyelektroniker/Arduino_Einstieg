...
//  void setRotation()
    ...
    int16_t drawText(const char* text, int16_t x, int16_t y, int16_t width, char align = 'l', int16_t xPadding=0, int16_t yPadding=0);
...
class TFTField {
  public:
    ...
    void setFgColor(uint16_t color);
    void setBgColor(uint16_t color);
    void setPos(int16_t x, int16_t y, int16_t width);
    void setPadding(int16_t x, int16_t y);
    void setAlignement(char value);
    void setText(const char* text);
    void setText(const String text);
    uint16_t getFieldWidth();
    uint16_t getFgColor();
    uint16_t getBgColor();
  ...
  private:
    ...
    int16_t _x, _y, _width;
    int16_t _xPadding, _yPadding;
    String _text;
    bool _initialized;
